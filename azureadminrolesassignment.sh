...
echo "Role assigned to Terraform StorageAccount."
...
echo "Role assigned to App Service Plan."
...
PRINCIPAL_ACCOUNT_CLOUD="$PRINCIPAL_ACCOUNT_CLOUD$AZ_ROOT_NAME$PRINCIPAL_ACCOUNT_SUFFIX_CLOUD"
