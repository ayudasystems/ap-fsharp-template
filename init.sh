...
sed -i "s/$CIRCLECI_PRINCIPAL_ACCOUNT_TAG/$SOLUTION_NAME_UPPERCASE/" .circleci/config.yml
sed -i "s/$CIRCLECI_PROJECT_NAME_TAG/$PROJECT_NAME/" .circleci/config.yml
sed -i "s/$CIRCLECI_SOLUTION_NAME_TAG/$SOLUTION_NAME_LOWERCASE/" .circleci/config.yml
